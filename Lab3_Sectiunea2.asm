...
data SEGMENT
a dd 0000110Ah, 10100000Dh, 00000003h, 20000004h
l equ ($ - a)/4
d db l dup (? )
data ENDS
code SEGMENT
...
repeta:
    ...
    test al, 00000001b     ;verificam daca e par sau impar   
    jnz skip_par_a         ;daca CF = 1 repetam din nou  
    
    test al, 10000000b     ;verificam daca e negativ, uitandune la bitul de semn 
